...
This is the second lecture in a series dedicated to regression modeling. We spent most of the lecture on a [hands-on R activity](https://docs.google.com/document/d/1Z59QvGl_H5h3Dkah7kzr2qhoHXSBKk8hHUordpEI7Dk/edit?usp=sharing) that illustrated some of the things that can go wrong when estimating linear models and how to diagnose those, how to model categorical variables and interpret the corresponding regression coefficients, how to model and interpret interaction effects, and how to work with standardized regression coefficients. I briefly referred to [this R notebook](../assets/activities/zscore.pdf) from last lecture. The solution to the Galton families activity is in [this R notebook](../assets/activities/GaltonFams.pdf).
