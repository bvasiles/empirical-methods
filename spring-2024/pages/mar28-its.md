## L19: Segmented Regression of Interrupted Time Series Data ([pdf](../slides/19-time-series.pdf), [video](https://youtu.be/IJ_ddr860co))

[![Lecture19-Interrupted-Time-Series](../assets/images/19-time-series.jpg)](../slides/19-time-series.pdf)
...
In this lecture we go over the [seasonality-trend decomposition](../assets/activities/ts.pdf) of time series and practice interrupted time series analysis hands-on (see [this notebook](../assets/activities/its.pdf)).
