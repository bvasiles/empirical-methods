## L18: Linear Regression (Part III) ([pdf](../assets/activities/typingSpeed.pdf), [video](https://youtu.be/_-0EzPHkp5s))

![Lecture18-Simpson](../assets/images/18-regression-pt3.jpg)

In this third lecture in the regression series we talked about [Simpson's paradox](https://en.wikipedia.org/wiki/Simpson's_paradox), how to account for within- and between- subject effects in the same model, and briefly about mixed-effects models. We also discussed the Twitter exemplar paper. We spent most of the time on an in-class hands-on activity using the [typing speed data](../assets/activities/typingSpeed.csv) -- see notebooks [one](../assets/activities/typingSpeed.pdf) and [two](../assets/activities/mixedEffects.pdf).
